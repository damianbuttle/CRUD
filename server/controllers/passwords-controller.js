...
exports.postForgotPassword = function(req, res, next){
  ...
  async.waterfall([
    ...
    function(token, user, done) {
      ...
      var mailOptions = {
        to: user.email,
        from: 'noreply@thegrowingcommunity.com',
        subject: 'Reset your password on thegrowingcommunity.com',
  ...
  async.waterfall([
    ...
    function(user, done) {
      ...
      var mailOptions = {
        to: user.email,
        from: 'noreply@thegrowingcommunity.com',
        subject: 'Your thegrowingcommunity.com password has been changed',
        text: 'Hello,\n\n' +
